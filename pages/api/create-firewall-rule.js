...
export async function createFirewallRule(id, ranges, res, ipType) {
    ...
    const firewallsClient = new compute.FirewallsClient({ credentials: serviceAccount });
    const operationsClient = new compute.GlobalOperationsClient({ credentials: serviceAccount });  
